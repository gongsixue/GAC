...
class Trainer:
    def __init__(self, args, model, criterion, optimizer, writer):
        ...
        self.params_log = ['LearningRate','idLoss', 'debLoss', 'n_adavk', 'n_norm']
    ...
    def train(self, dataloader, epoch):
        ...
        num_adavk, num_norm = self.get_num_adavk()
        ...
        for i, (inputs, labels, attrs, fmetas) in enumerate(dataloader):
            ...
            self.losses['n_adavk'] = num_adavk
            self.losses['n_norm'] = num_norm
